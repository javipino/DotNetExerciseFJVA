...
namespace Business.Users.Test
{
    public class UsersTest
    {
        ...
        public void Seed()
        {
            _repo.Truncate(new User());

            _repo.Insert(new User() { Name = "Test1", Birthdate = DateTime.Parse("30/11/1992") });
            _repo.Insert(new User() { Name = "Test2", Birthdate = DateTime.Parse("30/11/1999") });
